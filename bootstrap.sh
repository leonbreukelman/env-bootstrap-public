...
if ! gh auth status &> /dev/null; then
    ...
    echo "  1. Restore your age key from your password manager to ~/.age/key.txt"
    echo "  2. Get your secure repo name from your password manager"
    echo "  3. Clone your private config:"
    echo "     gh repo clone leonbreukelman/YOUR_SECURE_REPO ~/env-bootstrap"
    echo "  4. Run: ~/env-bootstrap/bootstrap.sh"
else
    ...
    echo ""
    echo "1. Restore your age key from your password manager:"
    echo "   mkdir -p ~/.age"
    echo "   nano ~/.age/key.txt  # paste key from password manager"
    echo "   chmod 600 ~/.age/key.txt"
    echo ""
    echo "2. Get your SECURE REPO NAME from your password manager (stored with age key)"
    echo ""
    echo "3. Clone and run private bootstrap:"
    echo "   read -p 'Secure repo name: ' SECURE_REPO"
    echo "   gh repo clone leonbreukelman/\$SECURE_REPO ~/env-bootstrap"
